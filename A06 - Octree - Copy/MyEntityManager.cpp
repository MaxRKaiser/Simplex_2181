...
void Simplex::MyEntityManager::Update(void)
{
	...
	for (uint i = 0; i < m_uEntityCount - 1; i++)
	{
		...
		{
			//only call colliding for obejects who share their main dimension (first leaf they appear in)
			if (m_mEntityArray[i]->m_uMainDimension == m_mEntityArray[j]->m_uMainDimension)
